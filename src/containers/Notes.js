...
export default class Notes extends Component {
	...
	async componentDidMount() {
		try {
		  let attachmentURL; /* let has "block scope" aka it does not exist outside fo this try block */
	...
	render() {
	  return (
		<div className="Notes">
		  {this.state.note &&  /* We render our form only when this.state.note is available. */
			<form onSubmit={this.handleSubmit}>
			  ...
			  {this.state.note.attachment && /* Likewise we conditionally render the attachment */
				<FormGroup>
